...
<!-- <form method="post" action="logon_inputpro.do" name="inputform"> -->
<form method="post" action="logon_inputpro.do" name="inputform" onsubmit="return inputcheck()">
		...
		<tr>
			<th colspan="2">
				...
				<input class="inputbutton" type="button" value="<%=btn_input_cancel%>"
						onclick="location='logon_main.do'">
			</th>
		</tr>
	</table>
</form>